...
int board_0, board_1, left_speed, right_speed, junction_no, lost_no, parcel_num(), package_type(), package_received(), line_follow(), pickup(),lost_line(), pick_package();
...
extern int board_0, board_1, left_speed, right_speed, junction_no, lost_no, parcel_num(), package_type(), package_received(), line_follow(), pickup(),lost_line(), pick_package();
